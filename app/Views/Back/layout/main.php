...
<head>
    ...
    <!-- Aqui o espaço reservado para apresentar css especifico das views que extendem esse template -->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Aqui o espaço reservado para apresentar o conteúdo das views especifico das views que extendem esse template -->
    ...
    <!-- Aqui o espaço reservado para scripts especifico das views que extendem esse template -->
